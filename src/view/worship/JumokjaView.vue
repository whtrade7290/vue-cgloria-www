            ...
            <div class="position-relative ms-md-5 me-md-n5">
              <div class="blur-shadow-image">
                <img
                  ...
                  src="http://160.251.179.146:3000/uploads/assets/jumok.jpg"
                />
              </div>
            </div>
            ...
            >
              <div class="blur-shadow-image">
                <img
                  ...
                  src="http://160.251.179.146:3000/uploads/assets/ju2.jpeg"
                />
              </div>
            </div>
          </div>
            ...
            <div class="position-relative ms-n4 mb-5 mt-8 d-md-block d-none">
              <div class="blur-shadow-image">
                <img
                  ...
                  style="width: 70%"
                  src="http://160.251.179.146:3000/uploads/assets/ju1.png"
                />
              </div>
            </div>
            <h3 class="mb-4">
              {{ $t('webContents.jumok.main') }}
            </h3>
            <p>
              {{ $t('webContents.jumok.content1') }}
            </p>
            <p>
              {{ $t('webContents.jumok.content2') }}
            </p>
            <p>
              {{ $t('webContents.jumok.content3') }}
            </p>
          </div>
        </div>
      </div>
