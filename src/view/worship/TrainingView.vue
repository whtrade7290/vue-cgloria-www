      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <p>
            ...
            교회의 영적 목적 이해 및 실현에 중점을 두는 목적 훈련으로 구성됩니다, 이는 교회와 개인의
            신앙 성장을 지향합니다.
          </p>
        </div>
        <div class="col-lg-12 mt-lg-0 mt-5 ps-lg-0 ps-0">
          ...
          <div class="p-3 info-horizontal">
            ...
            <div class="description ps-3">
              ...
              <p class="mb-0">
                제자훈련을 받은 성도들 중에서 교회의 리더(속장)로 세움 받을 사람을 훈련하는 과정으로
                1년의 과정이 필요합니다.
              </p>
            </div>
          </div>
          <div class="p-3 info-horizontal">
            ...
            <div class="description ps-3">
              ...
              <p class="mb-0">
                ‘속장이 살아야 속회가 살고 속회가 살아야 교회가 산다’는 신념으로, 소그룹의 생명력인
                속장훈련을 매주 세미나 형식으로 실시합니다.
              </p>
            </div>
          </div>
          <div class="p-3 info-horizontal">
          ...
          <div class="p-3 info-horizontal">
            ...
            <div class="description ps-3">
              ...
              <p class="mb-0">
                날마다 깨어 기도하는 삶을 체질화하기 위해서 1년 365일을 쉬지 않고 새벽기도회를 하고
                있습니다.
              </p>
            </div>
          </div>
