const INFO_JP = [
  { title: '教会紹介', icon: 'church', path: 'intro' },
  { title: '牧師紹介', icon: 'attribution', path: 'paster' },
  { title: '教会地図', icon: 'pin_drop', path: '' },
  { title: 'お知らせ', icon: 'info', path: 'notice' }
]
...
export { INFO_JP, SMALLGROUP, TESTIMONY, WORSHIP, SCHOOL, SOCIALIZE, WRITE, WITHDIARY }
